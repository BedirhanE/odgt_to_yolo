...
def download_crowd_dataset(output_dir, skip_download=True):
    ...
    crowd_url_dict = {"CrowdHuman_train01.zip": "134QOvaatwKdy0iIeNqA_p-xkAhkV4F8Y",
...
def process(set_='val', annotation_filename='annotation_val.odgt',
    ...
    set_path = output_dir / ('%train.txt' % set_)
...
def main():
    ...
    parser.add_argument('--dataset_path', default='CrowdHuman', type=str, help='Dataset name')
